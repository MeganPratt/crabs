...
captainGraphics(11) = drawLine(pt17 , pt11 , "k");
captainGraphics(12) = drawLine(pt6 , pt18 , "k");
captainGraphics(13) = drawLine(pt18 , pt12 , "k");
captainGraphics(14) = drawLine(pt13 , pt14 , "k");
captainGraphics(15) = drawLine(pt13 , pt14 , "k");
captainGraphics(16) = drawLine(pt15 , pt16 , "k");
endfunction
